...
public class ShowArchivedTasksPanel extends javax.swing.JPanel {

    /** Creates new form ShowArchivedTasksPanel */
    private  TaskList tList;
    private  Secretary secr;

    public ShowArchivedTasksPanel(TaskList tList,Secretary sec) {
        this.tList = tList;
        this.secr = sec;
        initComponents();
    }
    ...
    private class MyTableModel extends AbstractTableModel {
        ...
        public MyTableModel()
        {
            ArrayList<Task> array=secr.printTaskArchive(tList);
