...
public class ShowOpenTaskPanel extends javax.swing.JPanel {

    private Moderator mod;
    private TaskList tList;

    public ShowOpenTaskPanel(Moderator mod, TaskList tl) {
        this.mod = mod;
        tList = tl;
        initComponents();
    }
    ...
    private class MyTableModel extends AbstractTableModel {
        ...
        public MyTableModel() {
            ArrayList<Task> array=mod.printTaskOpen(tList);
